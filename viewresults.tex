...
\begin{figure}[h]
\begin{tabular}{cccc} 
 \IfFileExists{history#1.png}{\includegraphics[width=0.25\textwidth]{{history#1}.png}}{\fbox{\begin{picture}(10,10)\put(0,5){ not found } \end{picture}}}
&\IfFileExists{OptMxy#1.png}{\includegraphics[width=0.25\textwidth]{{OptMxy#1}.png} }{\fbox{\begin{picture}(10,10)\put(0,5){ not found } \end{picture}}}
&\IfFileExists{OptFA#1.png}{\includegraphics[width=0.25\textwidth]{{OptFA#1}.png}  }{\fbox{\begin{picture}(10,10)\put(0,5){ not found } \end{picture}}}
&\IfFileExists{OptMz#1.png}{\includegraphics[width=0.25\textwidth]{{OptMz#1}.png}  }{\fbox{\begin{picture}(10,10)\put(0,5){ not found } \end{picture}}}
\end{tabular}           
